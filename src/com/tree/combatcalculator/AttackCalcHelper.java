...
import com.tree.combatcalculator.nodes.DecisionNode;
import com.tree.combatcalculator.nodes.Node;
import com.tree.combatcalculator.nodes.ResultNode;
...
public class AttackCalcHelper {
	...
	public static float calculateValue(StaticAttackData permData,
			Node finalResNode) {
