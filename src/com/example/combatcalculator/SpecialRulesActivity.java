 ...
 */
public class SpecialRulesActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attacker_options_popup);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.attacker_options_popup, menu);
        return true;
    }
